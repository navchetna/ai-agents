...
export default function SupportPage() {
  ...
  const handleBugReport = (e: React.FormEvent) => {
    ...
    // In a real app, you would send this data to your backend
    alert(
      "Thank you for reporting this issue. We'll investigate and update you soon."
    );
  };
          ...
          <Card>
            ...
            <CardContent className="flex flex-col items-center justify-center space-y-4 py-8">
              ...
              <p className="text-center text-muted-foreground">
                We're working on bringing you real-time support through live
                chat. In the meantime, please use our contact form or check the
                FAQ.
              </p>
            </CardContent>
          </Card>
        ...
        <TabsContent value="community">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Learn from others and explore our guides
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="mb-2">
                  Join our community to discuss study tips, app features, and
                  more:
                </p>
