    ...
    books: [
      {
        ...
        type: "textbook",
        grade: 5,
        url: "/pdfs/rip-van-winkle.txt", // Update this line
      },
      {
        id: "eb1",
                          ...
                          <Box>
                            ...
                            {book.type === "textbook" && (
                              <>
                                ...
                                <Button variant="link" onClick={() => handleOpenPdf(book.url, book.title)}>
                                  View Textbook
                                </Button>
                              </>
                            )}
                    ...
                    {subject.notes.map((note) => (
                      <Card key={note.id}>
                        <CardContent sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                          ...
                          <Button variant="outline" href={note.fileUrl} download>
                            Download
                          </Button>
                        </CardContent>
                      </Card>
