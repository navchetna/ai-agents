...
import { TextField, Button, Card, CardContent, Typography, Box, Switch } from "@mui/material"
    ...
    >
      ...
      <Card
        sx={{
          width: 350,
          zIndex: 10,
          backgroundColor: mode === "light" ? "#E6F4FE" : "rgba(31, 41, 55, 0.8)", // Updated dark mode background
