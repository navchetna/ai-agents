...
export default function SettingsPage() {
  ...
  const [studyDuration, setStudyDuration] = useState(timerSettings.studyDuration / 60)
  const [breakDuration, setBreakDuration] = useState(timerSettings.breakDuration / 60)
        ...
        <TabsContent value="preferences">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="tts-speed">Text-to-Speech Speed: {ttsSpeed}x</Label>
                <Slider
                  id="tts-speed"
                  min={0.5}
                  max={2}
              ...
              <div className="flex items-center space-x-2">
                <Switch id="word-translation" checked={wordTranslation} onCheckedChange={setWordTranslation} />
                <Label htmlFor="word-translation">Enable word-level translation</Label>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
        <TabsContent value="study">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="study-duration">Study Duration: {studyDuration} minutes</Label>
                <Select
